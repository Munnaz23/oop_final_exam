...
trust_bank_limited = Bank("Trust bank limited", 'Saidpur')
opi = User('Muntasir Islam Munna', 'munna@gmail.com', 'sid', 1234)
opi.deposit(trust_bank_limited, 50000)
print(opi.Cheak_balance())
opi.withdrawal_amount(trust_bank_limited, 2500)
print(opi.Cheak_balance())
opi.take_loan(trust_bank_limited, 30000)
print(opi.Cheak_balance())
print(trust_bank_limited.total_available_balance())
print(trust_bank_limited.total_loan_amount())